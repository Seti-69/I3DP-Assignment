...
namespace RaceGame
{
    ...
    {
        protected CharacterController controller;       // This field is to contains an instance of the CharacterController
        /// <summary>
        ...
        protected bool isDead = false;                  // This field is to determine wether the character is dead
        /// <summary>
